        ...
        <Form className="contact-form"  onSubmit={sendEmail} >
          <Row className="mb-3" >
            <Col sm={12} md={6} className="mb-3 mb-md-0" >
              <Form.Label htmlFor="nameFrom" >First Name</Form.Label>
              <Form.Control  name="name_from" placeholder="First Name" />
            </Col>
            <Col sm={12} md={6} className="mb-3 mb-md-0" >
          ...
          <Form.Group className="mb-3" >
            ...
            <Form.Control type="email" name="email_from" placeholder="Enter Email" />
            <Form.Text>
